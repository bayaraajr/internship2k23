        ...
        <Layout>
            <div className='p-10'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 z-2 py-10'>
                    ...
                    {
                        cards.map((card, index) => <motion.div className="col-span-1" whileHover={{ scale: 1.8, translateX: index === 0 ? 200 : index === 1 ? 100 : index === 2 ? -100 : -200, zIndex: 999, y: 0 }} initial={{ opacity: 0, y: 100 }} whileInView={{ opacity: 1, y: 0 }} transition={{ type: 'spring', delay: .15 * index }}>
                            <GlassCard>
                                {card}
                            </GlassCard>
                        </motion.div>)
